...
--   pg_dump -d gis_analysis -U postgres -Fc > "E:\school\SQL\Classwork\Book1\data\gis_analysis_backup.dump"
...
--   pg_restore -C -d postgres -U postgres "E:\school\SQL\Classwork\Book1\data\gis_analysis_backup.dump"
...
--   pg_dump -t farmers_markets -d gis_analysis -U postgres -Fc > "E:\school\SQL\Classwork\Book1\data\farmers_markets_backup.dump"

-- Drop just that table to test:
--   psql -d gis_analysis -U postgres -c "DROP TABLE farmers_markets;"

-- Restore just that table:
--   pg_restore -d gis_analysis -U postgres "E:\school\SQL\Classwork\Book1\data\farmers_markets_backup.dump"
...
--   pg_dump -d analysis -U postgres -Fp > "E:\school\SQL\Classwork\Book1\data\analysis_plain.sql"
