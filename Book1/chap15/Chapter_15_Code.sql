...
CREATE OR REPLACE VIEW employees_tax_dept AS
    SELECT emp_id, first_name, surname, depart_id
    FROM employees
    WHERE depart_id = 1
    ORDER BY emp_id
...
INSERT INTO employees (first_name, surname, gender, email, depart_id, role_id, salary_id, overtime_id)
VALUES ('Suzanne', 'Legere', 'F', 'suzanne.legere@email.com', 1, 1, 1, 1);
