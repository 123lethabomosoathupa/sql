...
-- analysis=# \o 'E:\school\SQL\Classwork\Book1\data\state_counts.csv'
...
-- analysis(# );
-- analysis=# \copy state_regions FROM 'E:\school\SQL\Classwork\Book1\data\state_regions.csv' WITH (FORMAT CSV, HEADER);
...
--   shp2pgsql -I -s 4269 -W Latin1 "E:\school\SQL\Classwork\Book1\data\tl_2010_us_county10.shp" us_counties_2010_shp | psql -d gis_analysis -U postgres
