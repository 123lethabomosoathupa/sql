...
-- MAIN CODE + EXERCISES
-- Data files: E:\school\SQL\Classwork\Book1\data\
-- ================================================================
...
-- FROM 'E:\school\SQL\Classwork\Book1\data\crime_reports.csv'
...
-- FROM 'E:\school\SQL\Classwork\Book1\data\sotu-1946-1977.txt'
-- WITH (FORMAT TEXT, DELIMITER '|', ENCODING 'WIN1252');
...
-- Exercise 2: Find speeches mentioning 'president' within 5 positions
-- of 'snow' or 'winter' using the distance operator.
-- SELECT president, speech_date,
--        ts_headline(speech_text,
--                    to_tsquery('snow | winter'),
--                    'MinWords=5, MaxWords=7, MaxFragments=1')
-- FROM president_speeches
...
-- UPDATE crime_reports
-- SET second_date = (
--     SELECT (regexp_matches(original_text, '\d{1,2}\/\d{1,2}\/\d{2}', 'g'))[1]
--     OFFSET 1 LIMIT 1
-- )::timestamptz;
-- SELECT crime_id, date_1, second_date FROM crime_reports ORDER BY crime_id;
